...
public class NPC extends Entity {
    ...
    public void setDefeated(boolean status) {
        this.isDefeated = status;
    }

    public ArrayList<PokeRot> getNPCParty() {
        return this.npcParty;
    }

    public String[] getPreBattleDialogue() {
        return this.preBattleDialogue;
    }

    public String[] getPostBattleDialogue() {
        return this.postBattleDialogue;
    }
