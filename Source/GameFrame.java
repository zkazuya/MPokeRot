...
public class GameFrame extends JFrame {
    ...
    public GameFrame() {
        ...
        // gameIntro = new GameIntro(this);// has "this" so that the Panels will have
        // access to changing panels "switchPanel()"

        switcher = new CardLayout();

        switcherPanel = new JPanel(switcher);

        // switcherPanel.add(gameIntro, "Intro"); // assigning them names, so that we
        // can easily switch with them later on
